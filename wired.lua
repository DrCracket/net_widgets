...
local function worker(args)
  ...
  wired.icon:set_image(ICON_DIR.."wired.svg")
  wired_na.icon:set_image(ICON_DIR.."wired_na.svg")
...
return setmetatable(wired, {__call = function(_,...) return worker(...) end})
